                                                          ...
                                                          <table class="image_block block-1" width="100%" border="0" cellpadding="0" cellspacing="0" role="presentation" style="mso-table-lspace: 0pt; mso-table-rspace: 0pt;">
                                                              <tr>
                                                                  <td class="pad" style="width:100%;">
                                                                      <div class="alignment" align="center" style="line-height:10px"><img src="https://cdn.ameex.ma/app_data/uploads/img/8796571613974915.png" style="display: block; height: auto; border: 0; max-width: 190px; width: 100%;" width="190"></div>
                                                                  </td>
                                                              </tr>
                                                          </table>
                                                                  ...
                                                                  <td class="pad">
                                                                      ...
                                                                      ${
                                                                        name
                                                                          ...
                                                                          ${
                                                                            request_nature
                                                                              ? `<p style="margin: 0; margin-bottom: 16px;">Type de demande: <strong>${request_nature}</strong></p>`
                                                                              : ""
                                                                          }
                                                                          ${
                                                                            subject
                                                                              ? `<p style="margin: 0; margin-bottom: 16px;">Sujet: <strong>${subject}</strong></p>`
                                                                              : ""
                                                                          }
                                                                          ${
                                                                            service
